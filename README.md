...
A public record of published trading strategies tested with institutional rigor by an autonomous AI research pipeline. Each exhibit records the claim, the source, the stage that retired it, the statistical reason, and what $10k would have become versus an S&P index fund over the same window.
